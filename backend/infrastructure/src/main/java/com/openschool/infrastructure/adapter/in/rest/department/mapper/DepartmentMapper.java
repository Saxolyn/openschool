...
public class DepartmentMapper {
    ...
    public static DepartmentDto toDepartmentDto(Department department) {
        return DepartmentDto.builder()
                .departmentId((UUID) department.getDepartmentId())
    ...
    public static CreatedDepartmentCommand dtoToCreatedDepartmentCommand(DepartmentDto dto) {
    ...
    public static UpdateDepartmentCommand dtoToUpdatedDepartmentCommand(DepartmentDto dto) {
